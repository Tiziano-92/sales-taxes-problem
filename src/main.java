...
public class main {
	...
	public static void main(String[] args) {
		...
		ImportedGood imp3 = new ImportedGood("aaa","imported bottle of perfume", 1, new BigDecimal("27.99"));
		NonImportedGood nonig4 = new NonImportedGood("bbb","bottle of perfume", 1, new BigDecimal("18.99"));
		NonImportedGood nonig5 = new NonImportedGood("ccc","packet of headache pills", 1, new BigDecimal("9.75"), GoodType.MEDICAL_PRODUCT);
		ImportedGood imp4 = new ImportedGood("lll","imported box of chocolates", 3, new BigDecimal("11.25"), GoodType.FOOD);
